...
class AssetsFromEtmp @Inject() extends Transformer {
  ...
  def transform(assets: EtmpAssets): Assets =
    Assets(
            ...
            .map { landOrPropertyTransaction =>
              ...
              LandOrPropertyTransactions(
                ...
                heldPropertyTransaction = HeldPropertyTransaction(
                  ...
                  optLeaseDetails = heldPropertyTransaction.leaseDetails.map(leaseDetail =>
                    LeaseDetails(
                  ...
                  optTotalIncomeOrReceipts = heldPropertyTransaction.totalIncomeOrReceipts
                ),
      ...
      optBorrowing = assets.borrowing.map(borrowing =>
        Borrowing(
