...
import uk.gov.hmrc.pensionschemereturn.models.nonsipp.memberpayments.TransfersOut
import uk.gov.hmrc.pensionschemereturn.models.etmp.nonsipp.memberpayments.EtmpTransfersOut
