...
case class EtmpSippRegistryDetails(
  registryRefExist: YesNo,
  registryReference: Option[String],
  noRegistryRefReason: Option[String]
)
object EtmpSippRegistryDetails {
  implicit val format: OFormat[EtmpSippRegistryDetails] = Json.format[EtmpSippRegistryDetails]
}
