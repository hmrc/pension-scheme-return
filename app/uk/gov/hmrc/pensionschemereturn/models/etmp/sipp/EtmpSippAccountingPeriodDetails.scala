...
case class EtmpSippAccountingPeriodDetails(
  ...
  accountingPeriods: Option[List[EtmsSippAccountingPeriod]]
)
...
object EtmpSippAccountingPeriodDetails {
  implicit val formatEtmsSippAccountingPeriod: OFormat[EtmsSippAccountingPeriod] = Json.format[EtmsSippAccountingPeriod]
