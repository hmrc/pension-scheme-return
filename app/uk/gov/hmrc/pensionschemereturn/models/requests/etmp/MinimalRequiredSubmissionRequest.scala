...
case class MinimalRequiredSubmissionRequest(
...
object MinimalRequiredSubmissionRequest {
  implicit val writes: OWrites[MinimalRequiredSubmissionRequest] = Json.writes[MinimalRequiredSubmissionRequest]
}
