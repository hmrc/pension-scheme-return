...
package uk.gov.hmrc.pensionschemereturn.models.enumeration.binders

import play.api.mvc.PathBindable

object EnumPathBinder {

  def pathBinder[T <: Enumeration](enumValue: T)(implicit stringBinder: PathBindable[String]): PathBindable[T#Value] =
    new PathBindable[T#Value] {
